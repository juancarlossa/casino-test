    ...
    <div className="relative" style={{ width, height }}>
      ...
      >
        ...
        <path
          ...
          className="relative z-50 fill-[#F5F5F5] dark:fill-[#262626]"
        />
        ...
        <path
          ...
          className="z-50 fill-[#E5E5E5] dark:fill-[#404040]"
        />
        <defs>
      ...
      <div className="absolute left-[21.25px] top-[19.25px] h-[843.5px] w-[389.5px] overflow-hidden rounded-[55.75px]">
        <CardAtropos />
      </div>
    </div>
  );
