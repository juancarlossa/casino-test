...
export const AnimatedTestimonials = ({
  ...
  // ✅ Generar rotaciones fijas y estables
  const rotationMap = useMemo(() => {
    const angles = [-6, -3, 0, 3, 6];
    return testimonials.map((_, i) => angles[i % angles.length]);
  }, [testimonials]);
      ...
      <div className="relative grid grid-cols-1 gap-10 md:grid-cols-2 md:gap-20">
          ...
          <div className="relative h-80 w-full">
            <AnimatePresence>
              {testimonials.map((testimonial, index) => {
                const rotate = rotationMap[index];
                ...
                return (
                  <motion.div
                    ...
                    animate={{
                      ...
                      rotate: isActive(index) ? 0 : rotate,
        ...
        <div className="flex flex-col justify-between lg:py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-sm italic text-gray-500 dark:text-neutral-300 lg:text-lg">
